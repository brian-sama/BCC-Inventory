...
export const COLORS = {
  PRIMARY: '#1e40af', // Bulawayo Blue
  SECONDARY: '#eab308', // Bulawayo Gold
  ACCENT: '#15803d', // Bulawayo Green
};
...
export const ICONS = {
  ...
  Reports: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1 3m8.5-3 1 3m0 0h.5m-10.5 0h.5m4.5-6h1.5m-1.5-3h1.5m-1.5-3h1.5" />
    </svg>
  ),
  User: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
  ...
  Truck: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 17.25V4.5A2.25 2.25 0 0 1 6 2.25h10.5a2.25 2.25 0 0 1 2.25 2.25v3m-15 8.25h15m-15 0a2.25 2.25 0 0 0 2.25 2.25h11.25a2.25 2.25 0 0 0 2.25-2.25m-15 0v-4.5A2.25 2.25 0 0 1 6 11.25h10.5a2.25 2.25 0 0 1 2.25 2.25v4.5m-6.75 0V11.25" />
    </svg>
  ),
